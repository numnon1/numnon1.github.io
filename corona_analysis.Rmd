...
First, let's take a look at the various rows that we have available in our dataset. As we can see, this dataset contains useful global Coronavirus data that we can use for analysis.
