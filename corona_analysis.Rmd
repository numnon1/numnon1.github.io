...
We can see that starting from mid-March, there was a steep increase in cases. Let's filter the date to after March 15th so we can get a better view at the growth. For the filtered dates, we will also graph the newConfirmed, newDeath, and newRecovered columns. The additional columns indicate the amount of cases on a given day and will assist us in further analysis.
